...
Route::group(['middleware' => 'admin'], function () {
    ...
    Route::get('/admin/doctors', [AdminController::class, 'loadDoctorListing'])
        ->name('admin-doctors');
    Route::get('/admin/doctor-applications', [AdminController::class, 'loadDoctorApplications'])
        ->name('admin-doctor-applications');
    Route::get('/admin/doctor-applications/{applicationId}', [AdminController::class, 'loadDoctorApplicationDetail'])
        ->name('admin-doctor-application-detail');
