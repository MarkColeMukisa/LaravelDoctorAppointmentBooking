...
class FeaturedDoctors extends Component
{
    ...
    {
        if ($speciality_id != 0) {
            $this->featuredDoctors = Doctor::with(['speciality', 'doctorUser', 'schedules'])
            ...
            $this->featuredDoctors = Doctor::with(['speciality', 'doctorUser', 'schedules'])->where('is_featured', 1)->get();
        }
