   ...
   <form wire:submit="update" class="p-5">
        ...
        <div class="mt-4">
            ...
            <div class="mt-3 flex items-center gap-4">
                @if ($image)
                    <div>
                        <p class="text-sm text-gray-500">New Preview</p>
                        <img src="{{ $image->temporaryUrl() }}" class="mt-1 w-24 h-24 object-cover rounded-lg" alt="Preview">
                    </div>
                @endif
                @if ($current_image)
                    <div>
                        <p class="text-sm text-gray-500">Current</p>
                        <img src="{{ Storage::url($current_image) }}" class="mt-1 w-24 h-24 object-cover rounded-lg" alt="Current">
                    </div>
                @endif
            </div>
        </div>
