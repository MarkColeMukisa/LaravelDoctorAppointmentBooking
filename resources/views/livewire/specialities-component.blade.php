          ...
          <table class="min-w-full divide-y divide-gray-200 dark:divide-neutral-700">
            ...
            <tbody class="divide-y divide-gray-200 dark:divide-neutral-700">
              ...
              <tr>
                ...
                <td class="h-px w-auto whitespace-nowrap">
                  <div class="px-6 py-4">
                    <span class="text-sm font-medium text-gray-800 dark:text-neutral-200">{{$item->speciality_name}}</span>
                  </div>
                </td>
                <td class="h-px w-auto whitespace-nowrap">
                  <div class="px-6 py-4">
                    <div class="flex items-center gap-x-3">
                      <a href="/edit/speciality/{{$item->id}}" class="text-sm font-medium text-blue-600 hover:text-blue-800 dark:text-blue-500 dark:hover:text-blue-400">Edit</a>
