...
<head>
    ...
    <title>{{ config('app.name', 'AmSam Clinic') }}</title>
    ...
    <div class="min-h-screen bg-gray-100">
        ...
        <main>
            ...
            <div x-data="{ show: true }"
                ...
                class="fixed top-24 right-4 z-[100] max-w-sm bg-emerald-600 text-white text-sm rounded-lg shadow-lg px-4 py-3 flex items-center gap-2"
                role="alert">
            ...
            <div x-data="{ show: true }"
                ...
                <div class="rounded-md bg-blue-50 p-4">
                    <div class="flex">
                        ...
                        <div class="ml-3 flex-1 md:flex md:justify-between text-blue-700">
